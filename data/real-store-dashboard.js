(function () {
  ...
  const HEADER_SYNONYMS = {
    ...
    "价格": ["price", "sale price", "saleprice", "售价", "商品价格", "销售价", "活动价", "activity price", "activityprice"],
    "库存": ["stock", "inventory", "库存", "可售库存", "available stock", "availablestock"],
    "处罚记录": ["penalty", "penalty status", "penaltystatus", "restriction", "处罚", "违规记录", "限流记录"],
    "详情页更新时间": ["detail updated at", "detailupdatedat", "detail update time", "detailupdatetime", "详情页更新时间", "商品详情更新时间"],
    "详情页版本": ["detail version", "detailversion", "详情页版本", "商品详情版本"],
    "详情页哈希": ["detail hash", "detailhash", "content hash", "contenthash", "详情页哈希", "详情内容哈希"],
  ...
  function hydrateProductFromSource(product, sourceHeaders) {
    ...
    return {
      ...
      price: readNumber("价格"),
      stock: readNumber("库存"),
      penalty: readText("处罚记录"),
      detailUpdatedAt: readText("详情页更新时间"),
      detailVersion: readText("详情页版本"),
      detailHash: readText("详情页哈希"),
